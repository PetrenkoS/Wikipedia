...
public class SearchPageObject extends MainPageObject {
    ...
    private static final String
            ...
            SEARCH_NO_RESULT_AFTER_CLEAR_ELEMENT = "//*[@resource-id='org.wikipedia:id/search_empty_image']";
    ...
    public int getAmountOfFoundArticles() {
        ...
        this.waitForElementPresent(By.xpath(search_result_locator),
...
public void assertThereIsNoResultOfSearch() {
    ...
    public void assertNoResultOfSearchAfterCancel() {
        this.waitForElementPresent(By.xpath(SEARCH_NO_RESULT_AFTER_CLEAR_ELEMENT),
